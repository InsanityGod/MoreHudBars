...
public class DurabilityHudBarProvider : IItemSlotHudBarProvider
{
    ...
    public bool TryGetPercentage(IWorldAccessor world, ItemSlot itemSlot, out float percentage)
    {
        ...
        if(!MoreHudBarsConfig.Instance!.DurabilityBar.ShowEvenIfBarFull && !itemStack.Collectible.ShouldDisplayItemDamage(itemStack)) return false;
